...
const ImageModal: React.FC<ImageModalProps> = ({ isOpen, onClose, producto }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div 
          className="relative w-full max-w-4xl h-full max-h-[90vh] bg-transparent flex flex-col"
        ...
        <div className="flex-1 relative flex items-center justify-center p-4 min-h-0">
          <div className="relative w-full h-full max-w-3xl max-h-[60vh] flex items-center justify-center bg-white rounded-lg shadow-2xl">
            <img 
